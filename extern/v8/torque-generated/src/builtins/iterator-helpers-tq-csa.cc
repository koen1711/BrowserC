...
TF_BUILTIN(IteratorFilterHelperNext, CodeStubAssembler) {
  ...
  if (block12.is_used()) {
    ...
    tmp34 = FromConstexpr_intptr_constexpr_int31_0(state_, 40);
    }
    ...
    tmp42 = FromConstexpr_intptr_constexpr_int31_0(state_, 48);
    }
...
TF_BUILTIN(IteratorTakeHelperNext, CodeStubAssembler) {
  ...
  if (block12.is_used()) {
    ...
    tmp40 = FromConstexpr_intptr_constexpr_int31_0(state_, 40);
    }
...
TF_BUILTIN(IteratorFlatMapHelperNext, CodeStubAssembler) {
  ...
  if (block5.is_used()) {
    ...
    tmp18 = FromConstexpr_intptr_constexpr_int31_0(state_, 56);
    }
    ...
    compiler::CodeAssemblerExceptionHandlerLabel catch23__label(&ca_, compiler::CodeAssemblerLabel::kDeferred);
    { compiler::ScopedExceptionHandler s(&ca_, &catch23__label);
    tmp22 = FromConstexpr_intptr_constexpr_intptr_0(state_, 8);
    }
    if (catch23__label.is_used()) {
      compiler::CodeAssemblerLabel catch23_skip(&ca_);
      ca_.Goto(&catch23_skip);
    ...
    tmp29 = FromConstexpr_intptr_constexpr_int31_0(state_, 72);
    }
  ...
  if (block31.is_used()) {
    ...
    tmp82 = FromConstexpr_intptr_constexpr_int31_0(state_, 56);
    }
    ...
    tmp85 = FromConstexpr_intptr_constexpr_intptr_0(state_, 8);
    }
    ...
    tmp91 = FromConstexpr_intptr_constexpr_int31_0(state_, 72);
    }
    ...
    tmp95 = FromConstexpr_intptr_constexpr_int31_0(state_, 48);
    }
  ...
  if (block50.is_used()) {
    ...
    tmp124 = FromConstexpr_intptr_constexpr_int31_0(state_, 72);
    }
